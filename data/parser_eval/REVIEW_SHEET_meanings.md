...
**Skip when uncertain.** Easier to mark obvious failures than borderline calls. If 5 verses look totally clean, the substrate is in good shape.

**50 verses · 756 words to scan total**
...
- **ananta** _(seen as ananta)_ — endless, infinite (an- + anta 'end'); an epithet of Viṣṇu
- **vijaya** _(seen as vijayam)_ — victory (vi- + √ji 'conquer')
...
- **apratīkāra** _(seen as apratīkāram)_ — without resistance, defenseless (a- + pratīkāra 'counter-action')
- **aśastra** _(seen as aśastram)_ — weaponless (a- + śastra 'weapon')
...
- **kṣematara** _(seen as kṣemataram)_ — more conducive to well-being (kṣema 'well-being' + comparative -tara)
...
- **aśocya** _(seen as aśocyāḥ)_ — not to be grieved over (a- + śocya gerundive of √śuc)
...
- **janādhipa** _(seen as janādhipāḥ)_ — lord of people, king (jana 'people' + adhipa 'lord')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
...
- **vyavasāya** _(seen as vyavasāya)_ — resolve, determination, settled intention (vi- + ava- + √so 'destroy/finish' — 'cutting through to a decision')
- **ātmaka** _(seen as ātmikā)_ — having the nature of (ātman + -ka 'pertaining to')
...
- **ananta** _(seen as anantāḥ)_ — endless, infinite (an- + anta 'end'); an epithet of Viṣṇu
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **avyavasāyin** _(seen as avyavasāyinām)_ — irresolute, unsteady (a- + vyavasāya + -in: 'not possessing resolve')
...
- **saṃtuṣ** _(seen as saṃtuṣṭaḥ)_ — to be content (sam- + √tuṣ 'be satisfied')
...
- **saṃgraha** _(seen as saṃgraha)_ — summary (sam- + √grah 'grasp together')
...
- **vipratipatti** _(seen as vipratipattiḥ)_ — contradictory views, dispute (vi- 'apart' + prati- 'against' + √pad 'fall')
...
- **anavāpta** _(seen as anavāptam)_ — unobtained (an- + avāpta past-pple. of ava-√āp 'attain')
- **avāp** _(seen as avāptavyam)_ — to obtain (ava- + √āp 'reach')
...
- **jātu** _(seen as jātu)_ — ever, at any time
- **karman** _(seen as karmaṇi)_ — action, deed, the law of action
- **atandrita** _(seen as atandritaḥ)_ — unwearied (a- + tandrita 'lazy', from √tandr)
- **vartman** _(seen as vartma)_ — path, course, track
- **anuvṛt** _(seen as anuvartante)_ — to follow, conform (anu- + √vṛt 'turn')
...
- **yad** _(seen as yaḥ)_ — which, who (relative pronoun)
- **abhijñā** _(seen as abhijānāti)_ — to recognize, know (abhi- + √jñā 'know')
...
- **ajña** _(seen as ajñaḥ)_ — ignorant (a- + jña, from √jñā 'know')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **aśraddadhāna** _(seen as aśraddadhānaḥ)_ — without faith (a- + śraddadhāna pres.-pple. of √śrad-dhā 'have faith')
- **saṃśaya** _(seen as saṃśaya)_ — doubt (sam- + √śi 'lie/rest' — 'lying both ways')
- **ātman** _(seen as ātmā)_ — the Self, soul; one's own self
- **vinaś** _(seen as vinaśyati)_ — to perish (vi- + √naś 'be lost')
- **na** _(seen as na)_ — not (negation particle)
...
- **asakta** _(seen as asakta)_ — unattached, detached (a- + sakta past-pple. of √sañj 'cling')
- **ātman** _(seen as ātmā)_ — the Self, soul; one's own self
...
- **akṣaya** _(seen as akṣayam)_ — undecaying (a- + kṣaya 'decay', from √kṣi)
...
- **viyuj** _(seen as viyuktānām)_ — to disjoin, separate (vi- + √yuj 'yoke')
...
- **abhitas** _(seen as abhitas)_ — near, on all sides (abhi- + -tas)
- **brahman** _(seen as brahma)_ — Brahman (the Absolute); also: the Veda; sacred utterance
- **nirvāṇa** _(seen as nirvāṇam)_ — extinction, liberation (nis- + √vā 'blow out')
...
- **yogin** _(seen as yogī)_ — yogi (yoga + -in 'possessor of')
...
- **ekākin** _(seen as ekākī)_ — alone, solitary (eka 'one' + -ākin)
- **yam** _(seen as yata)_ — to restrain, control (verbal root); also: which (relative)
- **citta** _(seen as citta)_ — mind, thought, consciousness, mental substance
- **nirāśī** _(seen as nirāśīḥ)_ — without expectation (nis- + āśīs 'desire')
...
- **praśam** _(seen as praśānta)_ — tranquillity (pra- + √śam 'be calm')
- **ātman** _(seen as ātmā)_ — the Self, soul; one's own self
- **vigam** _(seen as vigata)_ — to depart (vi- + √gam 'go')
...
- **saṃyam** _(seen as saṃyamya)_ — to restrain (sam- + √yam 'restrain')
...
- **atīndriya** _(seen as atīndriyam)_ — beyond the senses (ati- 'beyond' + indriya 'sense')
...
- **sukṛtin** _(seen as sukṛtinaḥ)_ — righteous, doer of good (su- 'well' + kṛta 'done' + -in)
...
- **jñānin** _(seen as jñānī)_ — knower (jñāna 'knowledge' + -in 'possessor')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
...
- **avyakta** _(seen as avyaktam)_ — unmanifest (a- + vyakta past-pple. 'manifest', from vi-√añj)
- **vyakti** _(seen as vyaktim)_ — manifestation (vi- + √añj 'anoint/manifest')
- **āpad** _(seen as āpannam)_ — to befall, occur; calamity, distress
- **man** _(seen as manyante)_ — to think, regard, consider (verbal root)
- **mad** _(seen as mām)_ — I, me (1st person pronoun stem); also: to rejoice (verbal root)
- **abuddhi** _(seen as abuddhayaḥ)_ — lack of intelligence, foolishness (a- + buddhi)
...
- **avyaya** _(seen as avyayam)_ — imperishable (a- + vyaya 'perishable', from vi-√i 'go away')
- **anuttama** _(seen as anuttamam)_ — supreme (an- + uttama 'highest', superl. of ud)
...
- **samuttha** _(seen as samutthena)_ — having arisen (sam- + ud- + √sthā 'stand')
...
- **sammoha** _(seen as saṃmoham)_ — delusion (sam- 'completely' + moha 'confusion')
- **sarga** _(seen as sarge)_ — creation, emanation
- **yā** _(seen as yānti)_ — to go (verbal root)
- **paraṃtapa** _(seen as parantapa)_ — scorcher of foes (para 'foe' + tap 'burn')
...
- **karman** _(seen as karma)_ — action, deed, the law of action
- **puruṣottama** _(seen as puruṣottama)_ — the Supreme Person (puruṣa + uttama 'highest')
- **adhibhūta** _(seen as adhibhūtam)_ — the elemental / material plane
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **pravac** _(seen as proktam)_ — to declare (pra- + √vac 'speak forth')
...
- **mad** _(seen as mām)_ — I, me (1st person pronoun stem); also: to rejoice (verbal root)
- **upe** _(seen as upetya)_ — to approach (upa- + √i 'go')
...
- **aśāśvata** _(seen as aśāśvatam)_ — non-eternal (a- + śāśvata 'eternal', from √śaśvat)
- **na** _(seen as na)_ — not (negation particle)
- **āp** _(seen as āpnuvanti)_ — to obtain, reach (verbal root)
- **mahātman** _(seen as mahātmānaḥ)_ — great soul (mahat 'great' + ātman 'self')
- **saṃsiddhi** _(seen as saṃsiddhim)_ — perfection (sam- + √sidh 'attain')
...
- **yogin** _(seen as yogī)_ — yogi (yoga + -in 'possessor of')
- **prāp** _(seen as prāpya)_ — to obtain (pra- + √āp 'reach')
- **nivṛt** _(seen as nivartate)_ — to cease, turn back (ni- + √vṛt 'turn')
...
- **avyakta** _(seen as avyakta)_ — unmanifest (a- + vyakta past-pple. 'manifest', from vi-√añj)
...
- **jana** _(seen as janāḥ)_ — person, people, folk
- **paryupās** _(seen as paryupāsate)_ — to attend upon, worship (pari- + upa- + √ās 'sit')
- **tad** _(seen as teṣām)_ — that (distal demonstrative); also 3rd-person pronoun
- **nitya** _(seen as nitya)_ — eternal, permanent, daily
- **abhiyuj** _(seen as abhiyuktānām)_ — to attack, attach to (abhi- + √yuj 'yoke')
- **yoga** _(seen as yoga)_ — yoga; union, discipline, application
...
- **rājarṣi** _(seen as rājarṣayaḥ)_ — royal sage (rājan 'king' + ṛṣi 'seer')
- **tathā** _(seen as tathā)_ — thus, in that manner; likewise
- **anitya** _(seen as anityam)_ — impermanent (a- + nitya 'eternal')
- **asukha** _(seen as asukham)_ — unhappy, sorrowful (a- + sukha)
...
- **ahiṃsā** _(seen as ahiṃsā)_ — non-violence (a- + hiṃsā 'harming', from √hiṃs)
...
- **ayaśas** _(seen as ayaśaḥ)_ — infamy (a- + yaśas 'fame')
...
- **akṣara** _(seen as akṣaram)_ — imperishable (a- + kṣara, from √kṣar 'flow/perish'); syllable; the Imperishable (Brahman)
...
- **adṛṣṭa** _(seen as adṛṣṭa)_ — unseen (a- + dṛṣṭa past-pple. 'seen', from √dṛś); the unmanifest karmic residue
...
- **anādi** _(seen as anādi)_ — without beginning (an- + ādi 'beginning')
...
- **evaṃvidha** _(seen as evaṃvidhaḥ)_ — of this kind (evam 'thus' + vidha 'kind')
...
- **tu** _(seen as tu)_ — but, on the other hand (particle)
- **akṣara** _(seen as akṣaram)_ — imperishable (a- + kṣara, from √kṣar 'flow/perish'); syllable; the Imperishable (Brahman)
- **anirdeśya** _(seen as anirdeśyam)_ — indefinable (an- + nirdeśya 'definable', fr. nis-√diś 'point out')
- **avyakta** _(seen as avyaktam)_ — unmanifest (a- + vyakta past-pple. 'manifest', from vi-√añj)
- **paryupās** _(seen as paryupāsate)_ — to attend upon, worship (pari- + upa- + √ās 'sit')
- **sarvatra** _(seen as sarvatra)_ — everywhere
- **ga** _(seen as gam)_ — going, going to (suffix); short for gam
- **acintya** _(seen as acintyam)_ — inconceivable (a- + cintya 'thinkable', from √cint)
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **kūṭastha** _(seen as kūṭastham)_ — fixed at the summit, immutable (kūṭa 'peak' + stha 'standing')
- **acala** _(seen as acalam)_ — immovable (a- + cala 'moving', from √cal); also: mountain
...
- **aśubha** _(seen as aśubha)_ — inauspicious (a- + śubha 'auspicious')
- **parityāgin** _(seen as parityāgī)_ — renunciant (pari- 'around' + √tyaj 'abandon' + -in 'possessor of')
- **bhaktimat** _(seen as bhaktimān)_ — endowed with devotion (bhakti + -mat 'possessor of')
- **tad** _(seen as sa)_ — that (distal demonstrative); also 3rd-person pronoun
- **mad** _(seen as me)_ — I, me (1st person pronoun stem); also: to rejoice (verbal root)
...
- **maunin** _(seen as maunī)_ — silent sage (mauna 'silence' + -in)
- **saṃtuṣ** _(seen as saṃtuṣṭaḥ)_ — to be content (sam- + √tuṣ 'be satisfied')
- **yad** _(seen as yena)_ — which, who (relative pronoun)
- **kaścit** _(seen as kenacid)_ — someone, anyone
- **aniketa** _(seen as aniketaḥ)_ — homeless (a-/ni- + niketa 'abode')
...
- **vijñā** _(seen as vijñāya)_ — to discern (vi- + √jñā 'know')
- **bhāva** _(seen as bhāvāya)_ — being, state, mood, emotion, condition
- **upapad** _(seen as upapadyate)_ — to arise, befit (upa- + √pad 'fall')
...
- **prakṛti** _(seen as prakṛti)_ — primordial nature (pra- + √kṛ 'do' — 'that from which all is made')
...
- **asat** _(seen as asat)_ — non-being, untruth (a- + sat 'being', from √as)
...
- **prakṛti** _(seen as prakṛtyā)_ — primordial nature (pra- + √kṛ 'do' — 'that from which all is made')
- **eva** _(seen as eva)_ — indeed, truly, only (emphatic particle)
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **karman** _(seen as karmāṇi)_ — action, deed, the law of action
...
- **tathā** _(seen as tathā)_ — thus, in that manner; likewise
- **ātman** _(seen as ātmānam)_ — the Self, soul; one's own self
- **akartṛ** _(seen as akartāram)_ — non-doer (a- + kartṛ 'doer' from √kṛ)
- **tad** _(seen as sa)_ — that (distal demonstrative); also 3rd-person pronoun
...
- **prakāśa** _(seen as prakāśaḥ)_ — light, manifestation (pra- + √kāś 'shine')
- **upajan** _(seen as upajāyate)_ — to be born, arise (upa- + √jan)
- **jñāna** _(seen as jñānam)_ — knowledge, wisdom, cognition
- **yadā** _(seen as yadā)_ — when
- **tadā** _(seen as tadā)_ — then, at that time
- **vid** _(seen as vidyāt)_ — to know; to find (verbal root)
- **vivṛdh** _(seen as vivṛddham)_ — to grow, increase (vi- + √vṛdh 'grow')
...
- **pravṛtti** _(seen as pravṛttiḥ)_ — engagement, activity (pra- + √vṛt: 'turning-toward')
- **ārambha** _(seen as ārambhaḥ)_ — beginning, undertaking
- **karman** _(seen as karmaṇām)_ — action, deed, the law of action
- **aśama** _(seen as aśamaḥ)_ — restlessness (a- + śama 'peace', from √śam)
- **spṛhā** _(seen as spṛhā)_ — longing, desire
...
- **vivṛdh** _(seen as vivṛddhe)_ — to grow, increase (vi- + √vṛdh 'grow')
- **bharata** _(seen as bharata)_ — Bharata (ancestor of the Kurus); a descendant of Bharata
- **ṛṣabha** _(seen as ṛṣabha)_ — bull (often as 'best of'); ṛṣabha
...
- **atī** _(seen as atītya)_ — to pass beyond, transcend (ati- + √i 'go')
- **tri** _(seen as trīn)_ — three
- **dehin** _(seen as dehī)_ — embodied being; the soul in a body
- **deha** _(seen as deha)_ — body
- **samudbhava** _(seen as samudbhavān)_ — origin (sam- + ud- 'up' + √bhū 'become')
- **janman** _(seen as janma)_ — birth, origin
...
- **vimuc** _(seen as vimuktaḥ)_ — to release (vi- + √muc)
- **amṛta** _(seen as amṛtam)_ — immortal, the deathless, nectar (a- + mṛta past-pple. 'died', from √mṛ)
- **aś** _(seen as aśnute)_ — to eat / to pervade (verbal root, two homophonous roots)
...
- **prasṛ** _(seen as prasṛtāḥ)_ — to extend (pra- + √sṛ 'go forth')
- **tad** _(seen as tasya)_ — that (distal demonstrative); also 3rd-person pronoun
- **śākhā** _(seen as śākhāḥ)_ — branch (of a tree); recension of the Veda
- **guṇa** _(seen as guṇa)_ — quality, attribute (esp. the three guṇas: sattva/rajas/tamas)
- **pravṛdh** _(seen as pravṛddhāḥ)_ — grown up (pra- + √vṛdh 'grow forth')
...
- **anusaṃtan** _(seen as anusaṃtatāni)_ — to extend continuously (anu- + sam- + √tan 'stretch')
- **karman** _(seen as karma)_ — action, deed, the law of action
- **anubandhin** _(seen as anubandhīni)_ — binding, consequent (anu- + √bandh 'bind' + -in)
...
- **yad** _(seen as yat)_ — which, who (relative pronoun)
- **avāp** _(seen as avāpnoti)_ — to obtain (ava- + √āp 'reach')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **api** _(seen as api)_ — also, even, although
- **utkram** _(seen as utkrāmati)_ — to depart upward (ud- + √kram 'step out')
- **īśvara** _(seen as īśvaraḥ)_ — the Lord, controller, God
- **grah** _(seen as gṛhītvā)_ — to seize, grasp, accept (verbal root)
- **etad** _(seen as etāni)_ — this (proximal demonstrative)
- **saṃyā** _(seen as saṃyāti)_ — to go with, depart (sam- + √yā 'go')
...
- **sampad** _(seen as saṃpad)_ — prosperity (sam- + √pad 'fall/come together')
- **vimokṣa** _(seen as vimokṣāya)_ — release, liberation (vi- + √muc 'release')
...
- **abhijan** _(seen as abhijātaḥ)_ — to be born to, lineage (abhi- + √jan 'be born')
- **as** _(seen as asi)_ — to be (verbal root)
...
- **duṣpūra** _(seen as duṣpūram)_ — hard to fill, insatiable (dus- 'difficult' + √pṝ 'fill')
...
- **anvita** _(seen as anvitāḥ)_ — endowed with (anu- + √i 'go-after' past-pple. — 'followed by/possessed of')
- **moha** _(seen as mohāt)_ — delusion, infatuation, bewilderment
- **grah** _(seen as gṛhītvā)_ — to seize, grasp, accept (verbal root)
- **asat** _(seen as asat)_ — non-being, untruth (a- + sat 'being', from √as)
- **grāha** _(seen as grāhān)_ — shark, crocodile; a seizer
- **pravṛt** _(seen as pravartante)_ — to engage in (pra- + √vṛt 'turn forth')
- **aśuci** _(seen as aśuci)_ — impure (a- + śuci 'pure')
...
- **saṃyuj** _(seen as saṃyuktāḥ)_ — to join, unite (sam- + √yuj 'yoke')
- **kāma** _(seen as kāma)_ — desire, lust, sensual pleasure
...
- **yad** _(seen as yat)_ — which, who (relative pronoun)
- **dāna** _(seen as dānam)_ — giving, charity, gift
- **apātra** _(seen as apātrebhyaḥ)_ — unworthy recipient (a- + pātra 'vessel/recipient')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
- **dā** _(seen as dīyate)_ — to give (verbal root)
- **asatkṛ** _(seen as asatkṛtam)_ — to dishonor (asat + √kṛ: 'to make untrue / treat as nothing')
- **avajñā** _(seen as avajñātam)_ — contempt (ava- 'down' + √jñā 'know')
- **tad** _(seen as tat)_ — that (distal demonstrative); also 3rd-person pronoun
- **tāmasa** _(seen as tāmasam)_ — tāmasa (derived from tamas 'darkness': 'pertaining to the tamas guṇa')
- **udāhṛ** _(seen as udāhṛtam)_ — to declare, proclaim (ud- + ā- + √hṛ 'bring up')
...
- **prepsu** _(seen as prepsunā)_ — desirous of obtaining (desid. of pra-√āp)
- **karman** _(seen as karma)_ — action, deed, the law of action
- **yad** _(seen as yat)_ — which, who (relative pronoun)
- **tad** _(seen as tat)_ — that (distal demonstrative); also 3rd-person pronoun
- **sāttvika** _(seen as sāttvikam)_ — sāttvika (derived from sattva: 'pertaining to the sattva guṇa')
- **vac** _(seen as ucyate)_ — to speak (verbal root)
...
- **śraddhāvat** _(seen as śraddhāvān)_ — endowed with faith (śraddhā + -vat 'possessor of')
- **anasūya** _(seen as anasūyaḥ)_ — without envy (an- + asūyā 'envy/jealousy')
- **ca** _(seen as ca)_ — and; (homonym: also the consonant ca)
...
- **prāp** _(seen as prāpnuyāt)_ — to obtain (pra- + √āp 'reach')
